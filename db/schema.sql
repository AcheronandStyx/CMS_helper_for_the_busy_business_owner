...
CREATE TABLE roles (
    ...
    CONSTRAINT fk_department FOREIGN KEY (department_id) REFERENCES department(id) ON DELETE SET NULL -- If dept is deleted set the department_id of associated roles to NULL
);
...
CREATE TABLE employees (
    ...
    CONSTRAINT fk_manager FOREIGN KEY (manager_id) REFERENCES employees(id) ON DELETE SET NULL -- If managing employee is removed then remove their id from any direct reports line
);